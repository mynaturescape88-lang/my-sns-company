...
- **残る唯一の有料要素＝MiniMax Audio（ナレーション音声）**。課金形態は**従量でなく月額固定サブスク**（Starter $5/月・月10万クレジット付与）＝本数を増やしても追加の金銭コストはほぼ発生しない。詳細・出典は`.company/sns_accounts/youtube_ainsight.md`コスト性質欄が正本。
