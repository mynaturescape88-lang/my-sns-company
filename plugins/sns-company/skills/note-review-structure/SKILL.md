...
- ② `pm/review-baseline.md` の7観点を1つずつ照合（★観点7＝権利・合法性はfail-closed／特に観点4＝note.md戦略と相違ないか）
...
- [ ] 価格は `.company/sns_accounts/note.md` の確定方針どおりか（2026-06-15確定＝基本¥290・大型記事¥490で「広める」優先の低価格統一・¥100は不採用／親SKILL.md本文の旧「980円」でなく note.md を正本にする）・無料入門記事は価格設定なし （新規）
